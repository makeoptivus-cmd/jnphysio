        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6 animate-fade-up">
            ...
            <p className="text-sm md:text-base text-muted-foreground max-w-lg">
              ...
              dedicated to helping you recover, rehabilitate, and reclaim your
              active lifestyle.
            </p>
              ...
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex flex-wrap justify-center gap-1.5 pt-1.5">
                    {["BPT", "MPT (Ortho)", "MIAP", "CMFRT"].map((c) => (
                      <span
                        key={c}
                ...
                <p className="text-muted-foreground text-xs md:text-sm max-w-xs">
                  Specialized in orthopedic rehabilitation with a patient-first
